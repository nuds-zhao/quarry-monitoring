...
elseif Lnum == 8
    ...
    Lmax_B11 = str2double(geo_str(strmatch('RADIANCE_MAXIMUM_BAND_11',geo_str)+2));
    
    Lmax=[Lmax_B2,Lmax_B3,Lmax_B4,Lmax_B5,Lmax_B6,Lmax_B7,Lmax_B9,Lmax_B10,Lmax_B11];
    ...
    Lmin_B11 = str2double(geo_str(strmatch('RADIANCE_MINIMUM_BAND_11',geo_str)+2));
    
    Lmin=[Lmin_B2,Lmin_B3,Lmin_B4,Lmin_B5,Lmin_B6,Lmin_B7,Lmin_B9,Lmin_B10,Lmin_B11];
    ...
    Qcalmax_B11 = str2double(geo_str(strmatch('QUANTIZE_CAL_MAX_BAND_11',geo_str)+2));
    Qcalmax=[Qcalmax_B2,Qcalmax_B3,Qcalmax_B4,Qcalmax_B5,Qcalmax_B6,Qcalmax_B7,Qcalmax_B9,Qcalmax_B10,Qcalmax_B11];
    ...
    Qcalmin_B11 = str2double(geo_str(strmatch('QUANTIZE_CAL_MIN_BAND_11',geo_str)+2));
    Qcalmin=[Qcalmin_B2,Qcalmin_B3,Qcalmin_B4,Qcalmin_B5,Qcalmin_B6,Qcalmin_B7,Qcalmin_B9,Qcalmin_B10,Qcalmin_B11];
    ...
    char_doy=char(geo_str(strmatch('LANDSAT_SCENE_ID',geo_str)+2));
    doy=str2double(char_doy(15:17));
%    % Read vertical and false easting
%     ver=str2double(geo_str(strmatch('VERTICAL_LON_FROM_POLE',geo_str)+2));
%     east=str2double(geo_str(strmatch('FALSE_EASTING',geo_str)+2));
%     vert=[ver,east];
else
